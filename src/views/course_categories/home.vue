  ...
  export default {
    ...
    methods: {
      handleEdit(index, row) {
        ...
        this.$router.push({name:'courseCategoriesEdit',params:{id:row.id}})
      },
      handleDelete(index, row) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          type: 'warning'
           ...
           this.axios.delete(`admin/course_categories/${row.id}`).then(res=>{
                   this.init();
                     this.$message({
      ...
      add(){
          this.$router.push({name:"courseCategoriesAdd"})
      }
    }
  }
</script>
